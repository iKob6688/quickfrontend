...
export function AppLayout() {
  ...
  > = [
    ...
    { path: '/sales/notes', label: 'ใบเพิ่ม/ลดหนี้', scope: 'invoice', icon: 'bi-journal-minus' },
    ...
    { path: '/purchases/notes', label: 'ใบเพิ่ม/ลดหนี้ซื้อ', scope: 'purchase', icon: 'bi-journal-minus' },
